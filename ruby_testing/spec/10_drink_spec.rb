...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_beer) {described_class.new('beer', 16)}
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      # Create an explicit subject, using 'described_class' and your choice of
      # beverage type.
      subject(:my_beer1) {described_class.new('beer1', 16)}

      # remove the 'x' before running this test
      it 'is full' do
        expect(my_beer1).to be_full
      end
    end
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_beer2) {described_class.new('beer2', 5)}

      # remove the 'x' before running this test
      it 'is not full' do
        expect(my_beer2).to_not be_full
      end
    end
  end
end
